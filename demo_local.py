...
CONFIG = {
    ...
    "filipino_lexicon_path": "Fil_words_converted.csv", # Ensure this file is uploaded
...
def load_filipino_vader_lexicon(csv_path):
    try:
        if not os.path.exists(csv_path):
            ...
            uploaded_lex_files ="Fil_words_converted.csv" # Removed Colab upload prompt
...
if not os.path.exists(csv_file_path):
    ...
    try:
        ...
        if cleaned_df.empty:
            ...
            print(f"File saved: {comparison_filename}")
...
if all_gemini_recommendations_data:
    ...
    print(f"File saved: {all_gemini_recs_filename}")
else:
